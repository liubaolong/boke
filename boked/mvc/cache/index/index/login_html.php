...
<div class="htmleaf-container">
	<div id="wrapper" class="login-page">
	  <div id="login_form" class="form">
		<form class="register-form" action="index?m=index&c=login&a=register" method="POST">
		...
		<form class="login-form" action="login.php?id=2" method="POST">
...
<script src="<?php echo JS_PATH;?>jquery-2.1.1.min.js" type="text/javascript"></script>
