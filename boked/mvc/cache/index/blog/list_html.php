...
<body>
<form method="post" action="index.php?vid=1&m=admin&c=blog&a=list">
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        ...
        <li><input type="text" name="sousuo" style="height:40px;size:30;"></li>
		<li><input type="submit" value="搜索"></li>
		<li><a href="index.php?m=admin&c=blog&a=list" style="border:1px solid #999;">返回</a></li>
      </ul>


</form>
    </div>
<form method="post" action="index.php?m=admin&c=blog&a=list" id="listform">
    <table class="table table-hover text-center">
      ...
      <?php foreach($result as $key=>$value): ?>
        <tr>
          ...
          <td><div class="button-group" style="float:right;">  <a class="button border-red" href="index.php?id=<?=$value['bid']; ?>&m=admin&c=blog&a=list"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
       <?php endforeach;?>
      <tr>
